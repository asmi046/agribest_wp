    ...
    <section class="products-catalog">
        <div class="inner">
            ...
            <div class="view js__view">
                        ...
                        <button class="view__btn view__btn-grid js__grid <? if (empty($_COOKIE["vtype"])||($_COOKIE["vtype"] == "grid")) echo "view__btn_select"; ?>">
                            <span></span>
                            <span></span>
                            <span></span>
                            <span></span>
                        ...
                        <button class="view__btn view__btn-row js__row <? if ($_COOKIE["vtype"] == "plan") echo "view__btn_select"; ?>">
                            <span></span>
                            <span></span>
                            <span></span>
                            <span></span>
